...
function HeroSection() {
  return (
    <section className="relative min-h-screen flex flex-col justify-end items-center text-center px-5 pb-4 pt-20 overflow-hidden">
      <video
        autoPlay
        loop
        muted
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <p className="text-base sm:text-lg md:text-xl text-white/90 mb-6 md:mb-8 max-w-2xl mx-auto drop-shadow-md">
